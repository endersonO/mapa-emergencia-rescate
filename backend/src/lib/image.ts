 ...
 *
 * Allowlist cerrada: jpeg, png, webp. Nada de svg (XSS) ni gif. Portado tal cual
 * desde lib/image.ts del app Next previo (mismo trust boundary).
 */
 ...
 * rechaza explícitamente subtipos no permitidos (svg/gif).
 */
